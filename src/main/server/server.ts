...
import {
  PublicMessageWhenWhatsappUpdatedHandler
} from '../../modules/baileys/events/handlers/public-message-when-whatsapp-updated.handler';
...
app.listen(Config.port(), async () => {
  try {
    ...
    const queues = [
      ...
      // CONECTION
      { name: 'baileys-event-connection-open', routingKey: 'baileys.event.connection.open' },
      { name: 'baileys-event-connection-close', routingKey: 'baileys.event.connection.close' },
      { name: 'baileys-event-connection-all', routingKey: 'baileys.event.connection.*' },
      // PRESENCE
      { name: 'baileys-event-presence', routingKey: 'baileys.event.presence' },
      // MESSAGE
      { name: 'baileys-event-message', routingKey: 'baileys.event.message' },
      // CALL
      { name: 'baileys-event-call-offer', routingKey: 'baileys.event.call.offer' },
      { name: 'baileys-event-call-terminate', routingKey: 'baileys.event.call.terminate' },
      { name: 'baileys-event-call', routingKey: 'baileys.event.call.*' },
      // GROUP
      { name: 'baileys-event-group-created', routingKey: 'baileys.event.group.created' },
      { name: 'baileys-event-group-updated', routingKey: 'baileys.event.group.updated' },
      { name: 'baileys-event-group-participants-updated', routingKey: 'baileys.event.group.participants-updated' },
      { name: 'baileys-event-group', routingKey: 'baileys.event.group.*' },
    ];

    await messageBroker.createExchange(exchangeName, 'topic', { durable: true });
    ...
    eventDispatcher.register('EventOccurredWhatsappEvent', new PublicMessageWhenWhatsappUpdatedHandler() )
